 ...
 */
public class OrderBy<E extends Entity, H extends EntityByClassQueryable<E>> extends AbstractSqlSegmentContextAware<E, H> {
    private final List<String> segments = new ArrayList<>();
    private final EntityByClassQueryable<E> queryable;

    public OrderBy(ToSqlContext<E, H> context, EntityByClassQueryable<E> queryable) {
        super(context);
    ...
    public EntityByClassQueryable<E> ret() {
        return queryable;
    }

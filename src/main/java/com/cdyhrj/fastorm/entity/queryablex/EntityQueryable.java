...
import com.cdyhrj.fastorm.entity.queryablex.helper.ListQueryHelper;
import com.cdyhrj.fastorm.entity.queryablex.join.Join;
...
public class EntityQueryable<T extends Entity> implements ConditionHost<T> {
     ...
     */
    @Getter
    private final ToSqlContext<T, EntityQueryable<T>> context;
    /**
     * 连接
     */
    @Getter
    private final Joins<T, EntityQueryable<T>> joins;
     ...
     */
    @Getter
    private OrderBy<T, EntityQueryable<T>> orderBy;
    ...
    public EntityQueryable<T> joins(Joins<T, EntityQueryable<T>> joins) {
        return this;
    }

    public <E extends Entity> Join<T, EntityQueryable<T>, T, E> join(Class<E> entityClass) {
        return joins.addJoin(JoinType.INNER, entityClass);
    }

    public <E1 extends Entity, E2 extends Entity> Join<T, EntityQueryable<T>, E1, E2> join(Class<E1> sourceEntityClass, Class<E2> targetEntityClass) {
        return joins.addJoin(JoinType.INNER, sourceEntityClass, targetEntityClass);
    }

    public <E extends Entity> Join<T, EntityQueryable<T>, T, E> leftJoin(Class<E> entityClass) {
        return joins.addJoin(JoinType.INNER, entityClass);
    }

    public <E1 extends Entity, E2 extends Entity> Join<T, EntityQueryable<T>, E1, E2> leftJoin(Class<E1> sourceEntityClass, Class<E2> targetEntityClass) {
        return joins.addJoin(JoinType.INNER, sourceEntityClass, targetEntityClass);
    }

    public <E extends Entity> Join<T, EntityQueryable<T>, T, E> rightJoin(Class<E> entityClass) {
        return joins.addJoin(JoinType.INNER, entityClass);
    }


    public <E1 extends Entity, E2 extends Entity> Join<T, EntityQueryable<T>, E1, E2> rightJoin(Class<E1> sourceEntityClass, Class<E2> targetEntityClass) {
        return joins.addJoin(JoinType.INNER, sourceEntityClass, targetEntityClass);
    }
    ...
    public OrderBy<T, EntityQueryable<T>> orderBy() {
